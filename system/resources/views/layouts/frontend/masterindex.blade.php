		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="index"><img src="img/bangsat.png" height="75" width="100" alt=""></a>
			...
			<div class="row">
				<div class="col-lg-3  col-md-6 col-sm-6">
					<div class="single-footer-widget">
						<h6>About Us</h6>
						<p>
							Bangsat.id adalah tempat penyediaan Barang dan Jasa Ketapang yg dimana kami menyediakan berbagai macam barang dan jasa yang ada di Ketapang Kalimantan Barat
						</p>
					</div>
				</div>
